...
# Create nginx ingress to expose ports on the host IP (hostNetwork: true)

# Install nginx ingress
cat <<EOF > ingress-nginx-hostnetwork.yaml
apiVersion: v1
kind: Namespace
metadata:
  name: ingress-nginx
...
kubectl apply -f ingress-nginx-hostnetwork.yaml
